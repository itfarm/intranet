...
<?                          $faqID=$_GET['faqID'];
                            $catID=$_GET['catID'];
			                $sql=$christCMS->get_faq_single($faqID,$catID,"en");
							    ...
							    {  
								   ...
								   while ($arrFAQ = $christDB->f_GetRecord($result)) { 
											...
											echo'<tr><td valign="top" width="10%" >
													 <tr><td valign="top" ><b>'.$LBQuestion.'</b>&nbsp;:</td><td valign="top" >&nbsp;<i>'.$arrFAQ['question'].'</i></td></tr>
													 <tr><td valign="top" ><b>'.$LBAnswer.'</b>&nbsp;:</td><td valign="top" >&nbsp;'.$arrFAQ['answer'].'
													 </td></tr>
												';
												
												
										 }
								   echo'<tr><td colspan="2"><a href="'.$root_path.'modules/faq/index.php?menuid='.$menuid.'">'.$LBBackFAQList.'</a></td></tr>
								   </table>';
								}
							else{
								echo  $LBcontNotFound;
