...
$crumbs[2]['name'] = $LBMission;
$crumbs[2]['url'] = $root_path.'modules/pages/aboutus/mission.php?menuid='.$menuid.'&submenuid='.$submenuid;
?>
<table width="677" border="0" cellpadding="0" cellspacing="0" background="<?=$root_path?>/skins/default/images/content_bckgrd.gif">
  <tr>
    <td colspan="3" align="left" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td width="15" align="left" valign="top">&nbsp;</td>
    <td width="617" align="left" valign="top"><!--content starts here -->
<div id="content">
	<?=$LBBreadScrumb.'&nbsp;:&nbsp;'?>
    <?php 
	     $cnum = count($crumbs);
...
?>
<td width="240" align="left" valign="top" class="picture_02news">
