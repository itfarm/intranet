...
$crumbs[1]['url'] = $root_path.'modules/core/admin/project_Status/index.php?menuid='.$menuid;
		...
		//var_dump($_GET);
		 ...
		 $menuid=$_GET['menuid'];		 
		 $sql=$christCMS->delete_cont_status_single($statusID,$langCode);
...
<script language="JavaScript">
	        var pageURL='<?=$root_path?>modules/core/admin/project_Status/index.php?menuid=<?=$menuid?>';
